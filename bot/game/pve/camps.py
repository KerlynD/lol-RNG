...
CAMPS: dict[str, CampSpec] = {
    ...
    "drake_cloud": CampSpec(
        key="drake_cloud", name="Cloud Drake", tier=4, cooldown_range=(180, 180),
    ...
    "drake_ocean": CampSpec(
        key="drake_ocean", name="Ocean Drake", tier=4, cooldown_range=(180, 180),
        base_gold=1500, base_xp=250, weak_to=None,
    ...
    "drake_mountain": CampSpec(
        key="drake_mountain", name="Mountain Drake", tier=4, cooldown_range=(180, 180),
        base_gold=1500, base_xp=250, weak_to=None,
    ...
    "drake_infernal": CampSpec(
        key="drake_infernal", name="Infernal Drake", tier=4, cooldown_range=(180, 180),
        base_gold=1500, base_xp=250, weak_to=None,
    ...
    "drake_chemtech": CampSpec(
        key="drake_chemtech", name="Chemtech Drake", tier=4, cooldown_range=(180, 180),
        base_gold=1500, base_xp=250, weak_to=None,
    ...
    "drake_hextech": CampSpec(
        key="drake_hextech", name="Hextech Drake", tier=4, cooldown_range=(180, 180),
        base_gold=1500, base_xp=250, weak_to=None,
